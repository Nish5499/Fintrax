      ...
      <header className="relative">
        ...
        <nav className="relative z-10 container mx-auto px-4 py-5 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-foreground">FinTrax</span>
          </div>
          <div className="flex items-center gap-2">
            <Link to="/auth">
        ...
        <div className="relative z-10 container mx-auto px-4 pt-12 pb-20 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/20 mb-6">
            ...
            <span className="text-xs sm:text-sm text-primary font-medium">Smart Finance Management</span>
          </div>
          ...
          <p className="text-base sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-8 px-2">
